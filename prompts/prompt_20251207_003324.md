...
- **Available Methods:**
  ...
  * `create_task` (constant: `CREATE_TASK`)
  * `complete_task` (constant: `COMPLETE_TASK`)
  * `delete_task` (constant: `DELETE_TASK`)

---

# **Move Contract: `contract/todo_list/sources/todo_list.move`**
...
- Use Package ID: `0x572fe621c85d764c1564837f5deb8273dfe5631e8184ef4a08f49e83cecc67d5` and Module: `pizza`
